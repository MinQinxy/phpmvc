...
class View{
    ...
    public static function view(string $__viewname__,array $__var__ = array()) {
        ...
        // echo $__loader__->render();
        return $__loader__;
    }

    public static function view(string $__viewname__)
    {

        $__loader__ = View::selectViewTemplateLoader($__viewname__, array());

        // echo $__loader__->render();
        return $__loader__;
    }

    protected static function selectViewTemplateLoader(string $__viewname__, array $__var__){
